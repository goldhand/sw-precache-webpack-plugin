...
* `runtimeCaching`: `[Array<Object>]` - Configures runtime caching for dynamic content sucha as HTTP requests. Refer to [sw-precache ](https://github.com/GoogleChromeLabs/sw-precache#runtimecaching-arrayobject) to see all available options.
